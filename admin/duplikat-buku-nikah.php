                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="#" class="btn btn-sm btn-secondary print-surat"
                                                    ...
                                                    data-original-title="Cetak Duplikat Buku Nikah"><i
...
<div id="print-surat<?= $dta['id'] ?>" class="p-5" style="font-size: 14px; border: 1px solid;" hidden="">
    ...
    <div class="text-center" style="width: 50%; text-align: left; float: right;">Sebagai Duplikat sesuai dengan akta
        nikahnya</div><br>
    <div class="text-center" style="width: 50%; text-align: left; float: right;">Pegawai Pencatatan Nikah Sorong
        Kepulauan</div><br><br><br><br><br>
    <div class="text-center" style="width: 50%; text-align: left; float: right;">Suwandi Amin Sangaji</div>
