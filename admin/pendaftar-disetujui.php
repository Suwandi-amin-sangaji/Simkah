                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="#" class="btn btn-sm btn-success" data-toggle="modal"
                                                    data-target="#modal-next<?= $dta['id'] ?>" data-toggle1="tooltip"
                                                    data-original-title="Lanjutkan Pemeriksaan"><i
            ...
            <form method="POST">
                <div class="modal-body px-5">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="home" class="tab-pane fade in active show pt-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="nik_as" required autocomplete="off"
                                        placeholder="NIK Ayah Suami" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Nama Ayah Suami</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="nama_as" required autocomplete="off"
                                        placeholder="Nama Ayah Suami" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Agama</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="agama_as" required autocomplete="off"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="pekerjaan_as" required
                                        autocomplete="off" placeholder="Pekerjaan" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Alamat</label>
                                <div class="col-sm-6">
                                    <textarea type="text" class="form-control" name="alamat_as" required
                        ...
                        <div id="menu1" class="tab-pane fade pt-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="nik_is" required autocomplete="off"
                                        placeholder="NIK Ibu Suami" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Nama Ibu Suami</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="nama_is" required autocomplete="off"
                                        placeholder="Nama Ibu Suami" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Agama</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="agama_is" required autocomplete="off"
                                        placeholder="Agama" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Pekerjaan</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="pekerjaan_is" required
                                        autocomplete="off" placeholder="Pekerjaan" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Alamat</label>
                                <div class="col-sm-6">
                                    <textarea type="text" class="form-control" name="alamat_is" required
                                        placeholder="Alamat"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="home1" class="tab-pane fade pt-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="nik_ai" required autocomplete="off"
                                        placeholder="NIK Ayah Istri" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Nama Ayah Istri</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="nama_ai" required autocomplete="off"
                                        placeholder="Nama Ayah Istri" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Agama</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="agama_ai" required autocomplete="off"
                                        placeholder="Agama" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Pekerjaan</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="pekerjaan_ai" required
                                        autocomplete="off" placeholder="Pekerjaan" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Alamat</label>
                                <div class="col-sm-6">
                                    <textarea type="text" class="form-control" name="alamat_ai" required
                                        placeholder="Alamat"></textarea>
                                </div>
                            </div>
                        </div>
                        <div id="menu11" class="tab-pane fade pt-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="nik_ii" required autocomplete="off"
                                        placeholder="NIK Ibu Istri" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Nama Ibu Istri</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="nama_ii" required autocomplete="off"
                                        placeholder="Nama Ibu Istri" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Agama</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="agama_ii" required autocomplete="off"
                                        placeholder="Agama" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Pekerjaan</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="pekerjaan_ii" required
                                        autocomplete="off" placeholder="Pekerjaan" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Alamat</label>
                                <div class="col-sm-6">
                                    <textarea type="text" class="form-control" name="alamat_ii" required
                                        placeholder="Alamat"></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="jenis_mk" required autocomplete="off"
                                placeholder="Jenis Mas Kawin" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3">Jumlah Mas Kawin</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="jumlah_mk" required autocomplete="off"
                                placeholder="Jumlah Mas Kawin" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <button type="submit" name="set_pemeriksaan" class="btn btn-success mb-2">Simpan & Lanjutkan
                        Pemeriksaan</button>
