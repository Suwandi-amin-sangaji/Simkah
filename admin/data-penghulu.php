                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="#" class="btn btn-sm btn-danger" data-toggle="modal"
                                                    data-target="#modal-hapus<?= $dta['id'] ?>"><i
                ...
                <div class="modal-body px-5" style="margin-bottom: -20px;">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama" required autocomplete="off"
                            placeholder="Nama Penghulu">
                    </div>
                    <div class="form-group">
                        <label>NIP</label>
                        <input type="number" class="form-control" name="nip" required autocomplete="off"
                            placeholder="NIP">
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
                        <textarea class="form-control" name="alamat" required autocomplete="off" placeholder="Alamat"
                            rows="2"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Jabatan</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="no_telepon" required autocomplete="off"
            ...
            <form method="POST">
                <div class="modal-body px-5" style="margin-bottom: -20px;">
                    <div class="form-group">
                        <label>Nama Penghulu</label>
                        <input type="text" class="form-control" name="nama" required autocomplete="off"
                            placeholder="Nama Penghulu" value="<?= $dta['nama'] ?>">
                    </div>
                    <div class="form-group">
                        <label>NIP</label>
                        <input type="number" class="form-control" name="nip" required autocomplete="off"
                            placeholder="NIP" value="<?= $dta['nip'] ?>">
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
                        <textarea class="form-control" name="alamat" required autocomplete="off" placeholder="Alamat"
                            rows="2"><?= $dta['alamat'] ?></textarea>
                    </div>
                    <div class="form-group">
                        <label>Jabatan</label>
                        <select class="form-control" name="jabatan" required>
                            ...
                            <option value="<?= $jbt ?>" <?php if ($jbt == $dta['jabatan']) echo "selected" ?>>
                                <?= $jbt ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>No Telepon</label>
                        <input type="number" class="form-control" name="no_telepon" required autocomplete="off"
                            placeholder="No Telepon" value="<?= $dta['no_telepon'] ?>">
                    </div>
                    <div class="form-group">
                        <label>Status</label>
                        <select class="form-control" name="status" required>
                            ...
                            <option value="<?= $sts ?>" <?php if ($sts == $dta['status']) echo "selected" ?>><?= $sts ?>
                            </option>
                            <?php } ?>
                        </select>
                    </div>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    <a href="?hapus_data=true&id=<?= $dta['id'] ?>" role="button" class="btn btn-danger"
