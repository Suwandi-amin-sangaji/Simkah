                ...
                <div id="" class="p-1" style="font-size: 12px;">
                    <div class="row m-auto ">
                        ...
                        <div class="p-3 col-md-5"
                            style="height: 500px auto; border-radius: 20px; border: 5px solid; margin-right: 20px;">
                            <div class="row">
                            ...
                            <div class="">
                                <h6 class="text-center">REPUBLIK INDONESIA<br><br>KUTIPAN AKTA NIKAH<br><i>EXCERPT OF
                                        MARRIGAGE CERTIFICATE</i></h6>
                            ...
                            <div class="row">
                                ...
                                <div class="row" style="width: 60%;">
                                    : <div
                                        style="font-size: 13px; border-bottom: 1px dotted #000; width: 95%; margin-left: 5px;">
                                        <b>Sorong Kepulauan</b>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="rounded mx-auto d-block" style="margin-bottom: 5px;">
                                    <img src="../img/pasfoto/suami/<?= $dsm['pas_foto'] ?>"
                                        style="min-height: 3cm; max-height: 3cm; min-width: 2.5cm; max-width: 2.5cm; border: dashed 2px; width: 90px; margin-right: 40px;"
                                        class="thumn-sm">
                                    <img src="../img/pasfoto/istri/<?= $dis['pas_foto'] ?>"
                                        style="min-height: 3cm; max-height: 3cm; min-width: 2.5cm; max-width: 2.5cm; border: dashed 2px; width: 90px;"
                                        class="thumn-sm">
                                </div>
                            </div>
                        </div>
                        <div class="p-3 col-md-5" style="height: 500px auto; border-radius: 20px; border: 5px solid;">
                            <div class="">
                                <h6 class="text-center">KUTIPAN AKTA NIKAH<br><i>EXCERPT OF MARRIGAGE CERTIFICATE</i>
                                </h6>
                            </div>
                            <div class="row">
                                <div style="width: 40%;">
                                ...
                                <div class="row" style="width: 60%;">
                                    : <div
                                        style="font-size: 13px; border-bottom: 1px dotted #000; width: 95%; margin-left: 5px;">
                                        <b><?= str_replace('-', '/', $dta['no_pendaftarn']) ?></b>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="row" style="width: 60%;">
                                    : <div
                                        style="font-size: 13px; border-bottom: 1px dotted #000; width: 95%; margin-left: 5px;">
                                        <b><?= date('d/m/Y', strtotime($dta['tggl_akad'])) ?></b>
                                    </div>
                                </div>
                            ...
                            <div class="text-center">
                                <b>Telah dilangsungkan akad nikah seorang laki-laki :<br><i>There has been authenticated
                                        a convenant of mariage of a man :</i></b>
                            </div><br>
                            ...
                            <div class="row">
                                ...
                                <div class="row" style="width: 60%;">
                                    : <div
                                        style="font-size: 13px; border-bottom: 1px dotted #000; width: 95%; margin-left: 5px;">
                                        <b><?= $dsm['tempat_lahir'] . ', ' . date('d F Y', strtotime($dis['tggl_lahir'])) ?></b>
                                    </div>
                                </div>
                                <div style="width: 40%; margin-top: -5px;">
                    ...
                    <div class="row m-auto ">
                        ...
                        <div class="p-3 col-md-5" style="height: 500px auto; border-radius: 20px; border: 5px solid;">
                            ...
                            <div class="text-center">
                                <b>Telah dilangsungkan akad nikah seorang perempuan :<br><i>There has been authenticated
                                        a convenant of mariage of a woman :</i></b>
                            </div><br>
                            ...
                            <div class="row">
                                ...
                                <div class="row" style="width: 60%;">
                                    : <div
                                        style="font-size: 13px; border-bottom: 1px dotted #000; width: 95%; margin-left: 5px;">
                                        <b><?= $dis['tempat_lahir'] . ', ' . date('d F Y', strtotime($dis['tggl_lahir'])) ?></b>
                                    </div>
                                </div>
                                <div style="width: 40%; margin-top: -5px;">
                                    <div class=""><i>Place and date of birth</i></div>
