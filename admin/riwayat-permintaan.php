                                    ...
                                    <table id="dataTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge badge-<?= $dta['status'] == 'disetujui' ? 'success' : 'danger' ?>"><?= strtoupper($dta['status']) ?></span>
                                                </td>
                                                <td class="text-center">
                                                    <a href="#" class="btn btn-sm btn-link" data-toggle="modal"
                                                        data-target="#modal-berkas<?= $dta['id'] ?>"
                                                        data-toggle1="tooltip"
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="#" class="btn btn-sm btn-primary" data-toggle="modal"
                                                        data-target="#modal-status<?= $dta['id'] ?>"
                                                        data-toggle1="tooltip" data-original-title="Update Status"><i
