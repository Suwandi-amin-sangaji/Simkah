                ...
                <div class="modal-body px-5" style="margin-bottom: -20px;">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="username" required autocomplete="off"
                            placeholder="Username" value="<?= $adm['username'] ?>">
                    </div>
                    <div class="form-group">
...
<footer class="main-footer">
    ...
    </script> Direktorat Jenderal Bimbingan Masyarakat Islam | All rights reserved <i class="fa fa-heart-o"
        aria-hidden="true"></i> by <a href="https://sorongdev.com" target="_blank">Sorong
        Developer</a>
</footer>
...
<!-- <script src="asset/js/tampil.js"></script> -->
<script>
